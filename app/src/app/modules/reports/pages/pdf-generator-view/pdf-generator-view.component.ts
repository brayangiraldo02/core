...
@Component({
  selector: 'app-pdf-generator-view',
  standalone: false,
  templateUrl: './pdf-generator-view.component.html',
  styleUrl: './pdf-generator-view.component.css',
})
export class PdfGeneratorViewComponent {
